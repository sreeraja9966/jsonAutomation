...
public class LienRevokeAuthorizationTestCases extends TestBase{
...
ExecutionOfQuiresBeforeAnyTestCase executionOfQuiresBeforeAnyTestCase = new ExecutionOfQuiresBeforeAnyTestCase();
	...
	public void setUp() {
		...
		reportHelper.appendToExstingReport("Lien Revoke Authorization Verification");
...
public void LienRevokeInfoVerification(String LienRevokeInfoVerification) {
	...
	reportHelper.ChildTest("LienRevokeAuthInfoVerification");
	seleniumHelper.searchMenu("Lien Revoke Entry Authorization");
	seleniumHelper.clickElement("//a[contains(text(),'Lien Revoke Entry Authorization')]");
...
public void modelResponseVerificationinLienRevoke(String modelResponseVerificationinLienRevoke) {
	...
	reportHelper.ChildTest("modelResponseVerificationinLienRevokeAuth");
...
public void tableVerificationsInLienRevoke(String tableVerificationsInLienRevoke) {
	...
	reportHelper.ChildTest("tableVerificationsInLienRevokeAuth");
